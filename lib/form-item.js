...
var external_async_validator_ = __webpack_require__(12);
...
var form_itemvue_type_script_lang_ts_KFormItem = /** @class */ (function (_super) {
    ...
    Object.defineProperty(KFormItem.prototype, "fieldValue", {
        get: function () {
            ...
            return Object(util["a" /* getPropByPath */])(model, path, true).v;
        },
        enumerable: false,
        configurable: true
    });
    ...
    KFormItem.prototype.resetField = function () {
        ...
        var prop = Object(util["a" /* getPropByPath */])(model, path, true);
