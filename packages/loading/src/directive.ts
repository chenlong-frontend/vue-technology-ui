...
import { addClass, removeClass, getStyle } from 'kview-c-ui/src/utils/dom';
import { PopupManager } from 'kview-c-ui/src/utils/popup';
import afterLeave from 'kview-c-ui/src/utils/after-leave'

const Mask = Vue.extend(Loading);

const loadingDirective = {install:null};
loadingDirective.install = Vue => {
  ...
  Vue.directive('loading', {
    bind: function(el, binding, vnode) {
      ...
      const textExr = el.getAttribute('kview-loading-text');
      const spinnerExr = el.getAttribute('kview-loading-spinner');
