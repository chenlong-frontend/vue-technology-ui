...
<script type="text/babel">
  ...
  import Kview from 'main/index.js';
  ...
  export default {
    ...
    methods: {
      goCodepen() {
        ...
        '\n<scr' + `ipt src="//unpkg.com/kview-t-ui@${ version }/lib/index.js"></scr` + 'ipt>';
        let jsTpl = (script || '').replace(/export default/, 'var Main =').trim();
        let htmlTpl = `${resourcesTpl}\n<div id="app">\n${html.trim()}\n</div>`;
        let cssTpl = `@import url("//unpkg.com/kview-t-ui@${ version }/lib/theme-chalk/index.css");\n${(style || '').trim()}\n`;
        jsTpl = jsTpl
