  ...
  <transition name="kview-msgbox-fade">
    <div v-show="visible" role="dialog" class="kview-messagebox">
      <div class="kview-messagebox__container">
        <span @click="handleAction('close')" class="kview-messagebox__closeicon font_family icon-icon-close"></span>
        <div class="kview-messagebox__title">
          <span class="kview-messagebox__warnicon font_family icon-icon_warn"></span>
