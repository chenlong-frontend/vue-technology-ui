   ...
   <div v-show="visible" class="kview-dialog-container" :class="{'kview-dialog-container--center': center}">
      <div class="kview-dialog" :style="styles" :class="{'kview-dialog--center': center}">
        <transition :name="animationClass">
          <div v-show="contentAnimation || !animation" :style="{width, height}" >
            <div class="kview-dialog__close" v-if="closeBtn">
              <img :src="closeImg" />
              <span @click="handleClose" class="kview-dialog__icon font_family icon-icon-close"></span>
            </div>
...
const closeImg = require('@/kview/assets/dialog/close.png')
const dialogBottomImg = require('@/kview/assets/dialog/dialog-bottom.png')
const leftImg = require('@/kview/assets/dialog/left.png')
const rightImg = require('@/kview/assets/dialog/right.png')
